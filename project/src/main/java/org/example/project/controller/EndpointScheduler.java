...
import org.example.project.service.NodeService;
    ...
    public void syncDocs (Node node){
        ...
        try {
            ...
            for (Document document : documents) {
                ...
                documentService.addSyncDoc(document.getSiteId(), document.getUrl(),
                        document.getParentUrl(), document.getStatus(), document.getLevel(), document.getInsertDate().toString(), document.getNodeId());
